...
require (
	...
	github.com/PumpkinSeed/incrmntr v0.8.2
	github.com/PumpkinSeed/ptr v0.2.0
	github.com/PumpkinSeed/reflection v0.1.0
	github.com/brianvoe/devlog v0.2.1
	...
	github.com/fluidpay/dough v0.2.1
